<template>
    <div
      ...
      :class="optionState"
    >
      <div class="membership-option-header">
        <svg
        ...
        <ul>
          ...
          <svg width="10px" height="7px" viewBox="0 0 10 7" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                  <g class="checkmark" transform="translate(1.000000, 1.000000)" stroke="#000000">
  ...
  computed: {
    ...
    optionState() {
      ...
      if (this.$store.state.error === MEMBERSHIP_ERROR) {
        return 'error';
      } else if (selectedMembershipOption === this.option.title) {
        return 'active';
      } else if (selectedMembershipOption && selectedMembershipOption !== this.option.title) {
        return 'inactive';
      }
      return '';
    },
...
@import '@/styles/components/MembershipOption.scss';
</style>